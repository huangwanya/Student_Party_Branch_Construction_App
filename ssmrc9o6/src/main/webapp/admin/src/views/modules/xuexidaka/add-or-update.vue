<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="党史标题" prop="dangshibiaoti">
          <el-input v-model="ruleForm.dangshibiaoti" 
              placeholder="党史标题" clearable  :readonly="ro.dangshibiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="党史标题" prop="dangshibiaoti">
              <el-input v-model="ruleForm.dangshibiaoti" 
                placeholder="党史标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="党员账号" prop="dangyuanzhanghao">
          <el-input v-model="ruleForm.dangyuanzhanghao" 
              placeholder="党员账号" clearable  :readonly="ro.dangyuanzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="党员账号" prop="dangyuanzhanghao">
              <el-input v-model="ruleForm.dangyuanzhanghao" 
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          var json = data.data;
		if(json.dangyuanzhanghao!=''&&json.dangyuanzhanghao){
                this.ruleForm.dangyuanzhanghao = json.dangyuanzhanghao
	    		this.ro.dangyuanzhanghao = true;
		}
		if(json.dangyuanxingming!=''&&json.dangyuanxingming){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xuexidaka/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xuexidakaCrossAddOrUpdateFlag = false;
						 this.parent.search();
