...
public class DangyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		DangyuanEntity user = dangyuanService.selectOne(new EntityWrapper<DangyuanEntity>().eq("dangyuanzhanghao", username));
    ...
    public R register(@RequestBody DangyuanEntity dangyuan){
    	...
    	DangyuanEntity user = dangyuanService.selectOne(new EntityWrapper<DangyuanEntity>().eq("dangyuanzhanghao", dangyuan.getDangyuanzhanghao()));
		if(user!=null) {
